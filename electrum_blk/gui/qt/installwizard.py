...
from electrum_blk.util import UserCancelled, InvalidPassword, WalletFileException, get_new_wallet_name
from electrum_blk.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack, ReRunDialog
...
from electrum_blk.plugin import run_hook, Plugins
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.setWindowTitle('Electrum-PND  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Electrum-PND wallet'))
