...
from electrum_blk.storage import WalletStorage, StorageReadWriteError
from electrum_blk.wallet_db import WalletDB
from electrum_blk.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_blk.wallet import update_password_for_directory

from electrum_blk.plugin import run_hook
from electrum_blk import util
from electrum_blk.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                           format_satoshis, format_satoshis_plain, format_fee_satoshis,
                           maybe_extract_bolt11_invoice, parse_max_spend)
from electrum_blk.invoices import PR_PAID, PR_FAILED
from electrum_blk import blockchain
from electrum_blk.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_blk.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
...
#Factory.register('InstallWizard', module='electrum_blk.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_blk.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_blk.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_blk.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_blk_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_blk.gui.kivy.uix.screens')
...
from electrum_blk.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_blk.paymentrequest import PaymentRequest
...
class ElectrumWindow(App, Logger):
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            self.show_error(_("Not available for this wallet.") + "\n\n" +
                            _("Lightning is currently is not available for Blackcoin."))
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_blk.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_blk.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_blk_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_blk_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-PND', message,
                            app_icon=icon, app_name='Electrum-PND')
        except ImportError:
