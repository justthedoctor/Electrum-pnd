...
from electrum_blk.invoices import (PR_TYPE_ONCHAIN, PR_TYPE_LN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                               PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                               LNInvoice, pr_expiration_values, Invoice, OnchainInvoice)
from electrum_blk import bitcoin, constants
from electrum_blk.transaction import tx_from_any, PartialTxOutput
from electrum_blk.util import (parse_URI, InvalidBitcoinURI, TxMinedInfo, maybe_extract_bolt11_invoice,
...
from electrum_blk.gui.kivy import KIVY_GUI_PATH
from electrum_blk.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_blk.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_blk.util import create_bip21_uri
        amount = self.app.get_amount(self.amount)
