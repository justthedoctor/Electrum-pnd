...
from electrum_blk.invoices import pr_tooltips, pr_color
from electrum_blk.invoices import PR_UNKNOWN, PR_UNPAID, PR_FAILED, PR_TYPE_LN
...
Builder.load_string('''
#:import KIVY_GUI_PATH electrum_blk.gui.kivy.KIVY_GUI_PATH
