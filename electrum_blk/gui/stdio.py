...
from electrum_blk import WalletStorage, Wallet
...
class ElectrumGui(BaseElectrumGui):
    ...
    def __init__(self, *, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-blk create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-blk setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-blk setconfig' to change your settings")
        return True
