...
from electrum_pnd import bip32, constants
from electrum_pnd.i18n import _
from electrum_pnd.keystore import Hardware_KeyStore
from electrum_pnd.transaction import PartialTransaction
from electrum_pnd.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_pnd.util import bh2u, UserFacingException
from electrum_pnd.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_pnd.logging import get_logger
from electrum_pnd.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_pnd.simple_config import SimpleConfig
from electrum_pnd.json_db import StoredDict
from electrum_pnd.storage import get_derivation_used_for_hw_device_encryption
from electrum_pnd.bitcoin import OnchainOutputType

import electrum_pnd.bitcoin as bitcoin
import electrum_pnd.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def _get_coin(self):
        return bitbox02.btc.TBLK if constants.net.TESTNET else bitbox02.btc.PND
