...
from electrum_pnd import ecc
from electrum_pnd.i18n import _
from electrum_pnd.util import UserCancelled, UserFacingException
from electrum_pnd.keystore import bip39_normalize_passphrase
from electrum_pnd.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from electrum_pnd.logging import Logger
from electrum_pnd.plugin import runs_in_hwd_thread
from electrum_pnd.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the pandacoins in the wallet.").format(self.device)
        else:
